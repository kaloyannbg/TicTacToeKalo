//NEW VERSION, CLEAR SCREEN AFTER EVERY MOVE, AND SOME NEW FEATURES.
#include <stdio.h>
#include <stdlib.h>
...
void gameTitleAndPlayersInfo(void) { //Make function to save our game title and players info
...
int main()
{
    ...
    */
    ...
    system("cls"); // clean our screen after exit from the loop
